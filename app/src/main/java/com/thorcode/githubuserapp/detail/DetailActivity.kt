...
class DetailActivity : AppCompatActivity() {
    ...
    private fun showDetailUser(detailUser: DetailUser?){
        detailUser.let {
            ...
            binding.tvFollowers.text = resources.getString(R.string.followers, it?.followers.toString())
            binding.tvFollowing.text = resources.getString(R.string.following, it?.following.toString())
            Glide.with(this)
